...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class= "row" >
      ...
      {{-- <div class="col-sm-3" style="background-color: antiquewhite">Kolom c</div>
      <div class="col-sm-3" style="background-color: blanchedalmond">Kolom d</div>
      <div class= "row text-center" >
    </div>
      <div class="col-sm-6">Kolom e</div>
      <div class="col-sm-6">Kolom f</div>
    </div>
    </div> --}}
